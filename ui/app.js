  ...
  methods: {
    ...
    onKeypress(event) {
      if (event.key === "I" || event.key === "i") {
        fetch(`https://${GetParentResourceName()}/dag-openinv`, {
          method: 'POST'
        })
      }
    ...
    craftItem() {
      fetch(`https://${GetParentResourceName()}/dag-craftevent`, {
        method: 'POST',
        body: JSON.stringify({
    ...
    closeView() {
      this.visible = false;
      fetch(`https://${GetParentResourceName()}/dag-craft-close`, {
        method: 'POST'
      })
    },
    setData(data) {
